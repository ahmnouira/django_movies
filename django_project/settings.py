...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'movies', 'news',
    'accounts'
]
...
# The absolute filesystem path to the directory that will old user-uploaded files
...
# we need to include the django_project/static folder to the application settings
STATICFILES_DIRS = [
